...
export const antiDandruffGel: Product = {
  ...
  faqs: [{"q": "What is Veetree Anti-Dandruff Gel?", "a": "A refreshing scalp gel that helps control visible dandruff, soothe an uncomfortable scalp and maintain a clean, fresh and balanced-feeling scalp."}, {"q": "How do I use Anti-Dandruff Gel?", "a": "Apply On scalp At night or evening and Leave overnight. You can also leave on scalp for few hours. Then Rinse with shampoo."}, {"q": "What size is it?", "a": "100 g."}, {"q": "What is in it?", "a": "The full ingredient list is published on this page and printed on the pack. Key ingredients include Aloe vera gel, Teatree essential oil, Neem seed oil, Jojoba oil, Moringa seed oil."}, {"q": "Is a patch test needed?", "a": "Patch test on a small area of skin before first use, as with any new topical product."}],
