...
export const teaTreeHydrosol: Product = {
  ...
  faqs: [{"q": "What is Veetree Tea Tree Hydrosol?", "a": "A refreshing botanical mist that helps keep the skin feeling clean, fresh and balanced while providing lightweight hydration."}, {"q": "How do I use Tea Tree Hydrosol?", "a": "Step 1: Close your eyes and spray 2 to 4 pumps onto a clean face and neck (Acne Care), avoiding direct contact with the eyes. For scalp use, part your hair and spray directly onto a clean scalp (Dandruff Care). Step 2: Let it absorb naturally after spraying. On the scalp, gently massage with your fingertips."}, {"q": "What size is it?", "a": "100 ml."}, {"q": "What is in it?", "a": "The full ingredient list is published on this page and printed on the pack. Key ingredients include 100% Pure Form of Teatree Hydrosol through steam distillation process, Teatree Essential oil."}, {"q": "Is a patch test needed?", "a": "Patch test on a small area of skin before first use, as with any new topical product."}],
