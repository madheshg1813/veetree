...
export const earthEyeCream: Product = {
  ...
  faqs: [{"q": "What is Veetree Earth Eye Cream?", "a": "Provides nourishing hydration to the under-eye area and helps reduce the appearance of dark, tired and dull-looking eyes."}, {"q": "How do I use Earth Eye Cream?", "a": "Step 1: Take a pea-sized amount of Under Eye Cream & apply underneath your eye & around the brow bone. Step 2: Gently pat as you let the cream absorb. Do not let it close to the lids. Make this part of your daily regime to get healthy skin under your eyes."}, {"q": "What size is it?", "a": "15 g."}, {"q": "What is in it?", "a": "The full ingredient list is published on this page and printed on the pack. Key ingredients include Aqua, Herbs infusion, Bakuchiol oil, Kashmiri Saffron, Rosehip & Almond oil."}, {"q": "Is a patch test needed?", "a": "Patch test on a small area of skin before first use, as with any new topical product."}],
