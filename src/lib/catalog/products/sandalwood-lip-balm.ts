...
export const sandalwoodLipBalm: Product = {
  ...
  faqs: [{"q": "What is Veetree Sandalwood Lip Balm?", "a": "A nourishing natural-tinted lip balm that moisturises dry lips, keeps them soft and smooth, and adds a subtle, beautiful tint while helping improve the appearance of uneven lip tone."}, {"q": "How do I use Sandalwood Lip Balm?", "a": "Use it before applying lipstick so that the lips don't dry out. Can be applied to the cheeks as a highlighter. Use it as often as you can to hydrate your lips."}, {"q": "What size is it?", "a": "10 g."}, {"q": "What is in it?", "a": "The full ingredient list is published on this page and printed on the pack. Key ingredients include Shea butter, Cocoa butter, jojoba oil, Olive oil, almond oil."}, {"q": "Is a patch test needed?", "a": "Patch test on a small area of skin before first use, as with any new topical product."}],
