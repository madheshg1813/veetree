...
export const rosemaryHydrosol: Product = {
  ...
  faqs: [{"q": "What is Veetree Rosemary Hydrosol?", "a": "A refreshing scalp mist that helps revitalise the scalp, keep it feeling fresh and support a healthy-looking scalp and hair care routine."}, {"q": "How do I use Rosemary Hydrosol?", "a": "Spray directly onto the scalp and hair roots. Gently massage for 1–2 minutes. Use every morning and night on clean scalp and hair. Do not rinse. Style as usual."}, {"q": "What size is it?", "a": "100 ml."}, {"q": "What is in it?", "a": "The full ingredient list is published on this page and printed on the pack. Key ingredients include 100% Pure Form of Rosemary Hydrosol through steam distillation process, Rosemary Essential oil."}, {"q": "Is a patch test needed?", "a": "Patch test on a small area of skin before first use, as with any new topical product."}],
