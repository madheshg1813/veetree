...
export const mangoLipOil: Product = {
  ...
  faqs: [{"q": "What is Veetree Mango Lip Oil?", "a": "Deeply nourishes and softens dry lips while giving them a smooth, healthy-looking finish."}, {"q": "How do I use Mango Lip Oil?", "a": "Apply to clean, dry lips. Press or rub your lips together gently to distribute the oil evenly. Reapply whenever needed to lock in moisture and help improve the appearance of dry, dull & pigmented lips. Suitable for daily use."}, {"q": "What size is it?", "a": "10 ml."}, {"q": "What is in it?", "a": "The full ingredient list is published on this page and printed on the pack. Key ingredients include Mango Butter, Almond oil, Rosehip oil, Flaxseed oil Rich in Omega-3 fatty acids, Olive oil."}, {"q": "Is a patch test needed?", "a": "Patch test on a small area of skin before first use, as with any new topical product."}],
