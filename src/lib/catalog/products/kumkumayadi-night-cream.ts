...
export const kumkumayadiNightCream: Product = {
  ...
  faqs: [{"q": "What is Veetree Kumkumayadi Night Cream?", "a": "A nourishing night cream that works while you sleep to improve the appearance of dullness and hyperpigmentation, leaving the skin soft, moisturised and naturally radiant."}, {"q": "How do I use Kumkumadi Night Cream?", "a": "Cleanse your face and pat dry. Apply a small amount of Kumkumayadi Night Cream to the face and neck. Gently massage until fully absorbed. Use every night as the last step of your skincare routine."}, {"q": "What size is it?", "a": "30 g."}, {"q": "What is in it?", "a": "The full ingredient list is published on this page and printed on the pack. Key ingredients include Aqua, Rose hydrosol, Kumkumadi Thailam, :18+ Herbs blend, Kashmiri Saffron."}, {"q": "Is a patch test needed?", "a": "Patch test on a small area of skin before first use, as with any new topical product."}],
